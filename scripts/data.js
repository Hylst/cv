...
export const TIMELINE_DATA = [
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>1996 - 1998</span> <br> <span class='location-highlight'>Saint-Louis / Haut-Rhin (68)</span></div><div class='timeline-institution-block'><span class='timeline-subtitle'>Établissement</span><p>Lycée Jean Mermoz</p><p><em>Options :</em> Gestion, Anglais</p></div><div class='timeline-skills-block'><span class='timeline-subtitle'>Compétences Clés</span><ul><li>Conception, réalisation et maintenance de systèmes optiques</li><li>Lasers, fibre optique, imagerie</li><li>Physique des signaux et traitement du signal lumineux</li></ul></div><div class='timeline-projects-block'><span class='timeline-subtitle'>Projet</span><p>Optimisation de supports holographiques.</p></div>",
        "type": "education",
