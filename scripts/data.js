export const GLOSSARY = {
    ...
    "HTML": "HyperText Markup Language : le langage de balisage standard pour les documents web.",
    "CSS": "Cascading Style Sheets : langage de feuille de style pour la présentation des documents HTML.",
    "JavaScript": "Langage de programmation de scripts principalement utilisé dans les pages web interactives.",
    "PHP": "Langage de script généraliste et Open Source, spécialement conçu pour le développement d'applications web.",
    "Node.js": "Environnement d'exécution JavaScript côté serveur.",
    "Vue.js": "Framework JavaScript progressif pour construire des interfaces utilisateur.",
    "Angular": "Plateforme de développement d'applications web mobiles et de bureau.",
    "Joomla": "Système de gestion de contenu (CMS) libre, open source et gratuit.",
    "Strapi": "CMS Headless open-source pour construire des APIs rapidement.",
...
export const TIMELINE_DATA = [
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>Création en cours - début d'activité visé : octobre 2026</span> <br> <span class='location-highlight'>Brumath (67) - Distanciel France entière & présentiel Alsace</span></div><div class='timeline-role-block'><span class='timeline-subtitle'>Activité</span><p>Entreprise individuelle de développement d'applications, de sites internet et de conseil en traitement des données &amp; intelligence artificielle. Double compétence technique et métier : je conçois des solutions qui répondent réellement à l'activité du client.</p></div><div class='timeline-courses-block'><span class='timeline-subtitle'>Offre de services</span><div class='services-accordion'>  <details class='service-category'>    <summary><i class='fas fa-code service-icon'></i> D&eacute;veloppement d'applications &amp; sites internet</summary>    <div class='service-content'>      <ul class='service-list'>        <li>Applications web sur mesure et applications m&eacute;tier</li>        <li>Sites vitrines et sites e-commerce avec back-office (commandes, stocks, paiements)</li>        <li>Reprise et s&eacute;curisation de sites et applications existants</li>        <li>Migrations d'applications et de sites internet</li>        <li>Optimisation du r&eacute;f&eacute;rencement, de l'exp&eacute;rience utilisateur et des co&ucirc;ts de fonctionnement</li>      </ul>      <p class='service-note'><i class='fas fa-universal-access'></i> Accessibilit&eacute; RGAA/WCAG int&eacute;gr&eacute;e d&egrave;s la conception.</p>    </div>  </details>  <details class='service-category'>    <summary><i class='fas fa-database service-icon'></i> Num&eacute;risation, donn&eacute;es &amp; gouvernance</summary>    <div class='service-content'>      <ul class='service-list'>        <li>Accompagnement &agrave; la num&eacute;risation et &agrave; la centralisation des documents</li>        <li>Conseil en gouvernance : strat&eacute;gie de stockage, structure, acc&egrave;s et flux de donn&eacute;es</li>        <li>Organisation et traitement des donn&eacute;es</li>        <li>Solutions de recherche, assistance et automatisation par intelligence artificielle</li>        <li>Structuration de donn&eacute;es, tableaux de bord, accompagnement RGPD et souverainet&eacute;</li>      </ul>      <p class='service-note'><i class='fas fa-shield-alt'></i> Souverainet&eacute; et confidentialit&eacute; : h&eacute;bergement europ&eacute;en, s&eacute;curit&eacute;, r&eacute;silience.</p>    </div>  </details>  <details class='service-category'>    <summary><i class='fas fa-robot service-icon'></i> Conseil &amp; int&eacute;gration d'IA</summary>    <div class='service-content'>      <ul class='service-list'>        <li>&Eacute;tude de faisabilit&eacute; et s&eacute;lection de solutions d'IA adapt&eacute;es &agrave; votre activit&eacute;</li>        <li>Int&eacute;gration d'assistants et chatbots sur votre site ou outils internes</li>        <li>Automatisation intelligente de t&acirc;ches r&eacute;p&eacute;titives (documents, e-mails)</li>        <li>Formation de vos &eacute;quipes aux usages responsables de l'IA</li>        <li>Cadrage et int&eacute;gration dans un cadre d'utilisation encadr&eacute; et s&eacute;curis&eacute;</li>      </ul>      <p class='service-note'><i class='fas fa-balance-scale'></i> Conformit&eacute; AI Act europ&eacute;en, transparence et approche sobre.</p>    </div>  </details>  <details class='service-category'>    <summary><i class='fas fa-tasks service-icon'></i> Gestion de projets num&eacute;riques</summary>    <div class='service-content'>      <ul class='service-list'>        <li>Cadrage et r&eacute;daction de cahier des charges</li>        <li>Pilotage de projets de sites ou d'applications</li>        <li>Coordination entre &eacute;quipes techniques et &eacute;quipes m&eacute;tier</li>        <li>Suivi budg&eacute;taire, reporting et recette</li>      </ul>    </div>  </details>  <details class='service-category'>    <summary><i class='fas fa-palette service-icon'></i> Design &amp; cr&eacute;ation de m&eacute;dias</summary>    <div class='service-content'>      <ul class='service-list'>        <li>Cr&eacute;ation d'identit&eacute; visuelle (logo, charte graphique, supports)</li>        <li>Composition de musiques originales, jingles et habillage sonore</li>        <li>Montage vid&eacute;o et motion design</li>        <li>Traitement audio : nettoyage, mixage, sound design</li>        <li>Visuels 3D et illustrations</li>      </ul>      <p class='service-note'><em>Cr&eacute;ations sign&eacute;es Hylst, alias artistique du fondateur.</em></p>    </div>  </details>  <details class='service-category'>    <summary><i class='fas fa-pen-fancy service-icon'></i> R&eacute;daction technique, commerciale &amp; litt&eacute;raire</summary>    <div class='service-content'>      <ul class='service-list'>        <li>Documentation utilisateur et guides de prise en main</li>        <li>Contenus de site vitrine, newsletters et e-mails commerciaux</li>        <li>R&eacute;daction ou relecture de cahiers des charges en langage clair</li>        <li>Structuration et relecture de manuscrits ou d'ouvrages techniques</li>      </ul>    </div>  </details></div></div><div class='timeline-skills-block'><span class='timeline-subtitle'>Engagements</span><ul><li>Accessibilité (RGAA / WCAG) intégrée dès la conception, pas ajoutée après coup</li><li>Souveraineté et confidentialité des données : hébergement européen, RGPD</li><li>Livrables documentés, testés, et dont vous restez propriétaire</li></ul></div>",
        "type": "experience",
        "url": null,
        "logo": null
    },
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>2024 - 2025</span> <br> <span class='location-highlight'>Autoformation en ligne</span></div><div class='timeline-description-block'><span class='timeline-subtitle'>Type de Formation</span><p>Apprentissage autodirigé - Domaine IA & Développement Web</p><p><em>Légende : * Bases | ** Notions</em></p></div><div class='timeline-courses-block'><span class='timeline-subtitle'>Programme</span><h4>Développement Web & Front-End :</h4><ul><li><i class=\"fab fa-html5 timeline-icon\"></i> HTML / <i class=\"fab fa-css3-alt timeline-icon\"></i> CSS / <i class=\"fab fa-js timeline-icon\"></i> JS</li><li><i class=\"fab fa-react timeline-icon\"></i> React*, Next.js**, Vite**</li><li><i class=\"fab fa-php timeline-icon\"></i> PHP, <i class=\"fab fa-node timeline-icon\"></i> Node.js*, Express**</li><li>Tailwind, Web Components**, PWA*, SEO</li></ul><h4>Architecture & DevOps :</h4><ul><li>SSR/SSG, Headless CMS (Strapi*), Three.js (bases)</li><li><i class=\"fab fa-docker timeline-icon\"></i> Docker*, <i class=\"fab fa-git-alt timeline-icon\"></i> Git / GitHub, Apache/Nginx</li><li>CI/CD, Sécurité*, DevOps*, Bash*</li></ul><h4>Automatisation & Intégrations :</h4><ul><li>n8n/Make, Zapier, Apps Script</li><li><i class=\"fab fa-python timeline-icon\"></i> Python/Bash*</li><li>GitHub Actions**, Webhooks, Scrapy*, Luigi*</li></ul><h4>IA Générative & LLMs :</h4><ul><li>Prompt Engineering, RAG, Fine-tuning, agents IA</li><li>Vector DBs, Hugging Face, LlamaIndex**, LangChain**</li><li>GPT/LLMs (texte/image/vidéo/musique)</li></ul></div><div class='timeline-projects-block'><span class='timeline-subtitle'>Projets</span><ul><li><strong>Conception d'apps et sites web assistés par IA</strong> (Neuro-diversité, IA, Green IT, Apprentissage)</li><li><strong>Apps d'aide à l'apprentissage & assistance cognitive</strong> (Dys, TDA/H, TSA, Troubles mémoire/concentration)</li></ul><p>Portfolio : <em>hylst.fr</em></p></div>",
        "type": "education",
        "url": null,
        "logo": null
    },
    {
        "year": "2023 - 2024",
        "title": "Formation Python, Data Science & IA",
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>Mars 2004 - Sept 2024 (20 ans 6 mois)</span> <br> <span class='location-highlight'>Vendenheim, Fegersheim et Schweighouse (67)</span></div><div class='timeline-role-block'><span class='timeline-subtitle'>Missions & Rôles</span><p>Rôles variés : Coordinateur commercial, Vendeur, Responsable SAV, Chef de rayon électroménager, Attaché de direction, Livreur - installateur, Dépanneur.</p></div><div class='timeline-skills-block'><span class='timeline-subtitle'>Compétences Développées</span><ul><li>Vente, Coordination, Management d'équipe</li><li>Gestion de rayon (électroménager / électro-loisir, informatique / Hifi / Vidéo / TV, mobilité urbaine / accessoires), Gestion des litiges et SAV</li><li>Relation client et fournisseurs</li><li>Achat et marketing</li><li>Dépannage et installation, Planification, communication, formation</li></ul></div>",
        "type": "experience",
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>Fév - Juillet 2001 (6 mois)</span> <br> <span class='location-highlight'>Corbreuse (91)</span></div><div class='timeline-company-block'><span class='timeline-subtitle'>Activité de l'entreprise</span><p>Bureau d’études / ingénierie spécialisé dans la « vision industrielle » - conception de caméras, capteurs opto-électroniques et produits de vision industrielle / optique.</p></div><div class='timeline-role-block'><span class='timeline-subtitle'>Mission</span><p>Réalisation de programmes de sauvegarde, restauration, formatage de données pour système embarqué (caméra intelligente linéaire).</p></div>",
        "type": "experience",
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>1998 - 1999</span> <br> <span class='location-highlight'>Mulhouse / Haut-Rhin (68)</span></div><div class='timeline-institution-block'><span class='timeline-subtitle'>Établissement</span><p>Lycée Louis Armand</p></div><div class='timeline-description-block'><span class='timeline-subtitle'>Type de Formation</span><p>Classe préparatoire Adaptation Technicien Supérieur pour l'entrée en école d'ingénieur.</p></div><div class='timeline-courses-block'><span class='timeline-subtitle'>Compétences Travaillées</span><ul><li>Mathématiques avancées pour l'ingénierie</li><li>Physique, Physique quantique</li><li>Thermodynamique</li><li>Mécanique</li><li>Électronique</li></ul></div>",
        "type": "education",
        "url": null
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>1996 - 1998</span> <br> <span class='location-highlight'>Saint-Louis / Haut-Rhin (68)</span></div><div class='timeline-institution-block'><span class='timeline-subtitle'>Établissement</span><p>Lycée Jean Mermoz</p></div><div class='timeline-description-block'><span class='timeline-subtitle'>Options</span><p>Gestion, Anglais</p></div><div class='timeline-skills-block'><span class='timeline-subtitle'>Compétences Clés</span><ul><li>Principes scientifiques : optique, lasers, fibres optiques</li><li>Techniques de fabrication pour concevoir, intégrer et maintenir des systèmes optiques complexes</li><li>Analyse de cahiers des charges, réalisation de documents techniques</li><li>Procédures d'assemblage, de réglage et de test (optique, mécanique, logiciel)</li><li>Démarche qualité et gestion de maintenance</li><li>Travail en équipe et communication en anglais technique</li></ul></div><div class='timeline-projects-block'><span class='timeline-subtitle'>Projet</span><p><strong>Optimisation de supports holographiques</strong></p><p>Collaboration avec l'ENSCMU : optimisation de méthodes d'enregistrement sur supports photo-polymérisables.</p><p><em>Technologies :</em> Holographie, Chimie, Optique</p></div>",
        "type": "education",
    ...
    },
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>1994 - 1996</span> <br> <span class='location-highlight'>Strasbourg / Bas-Rhin (67)</span></div><div class='timeline-institution-block'><span class='timeline-subtitle'>Établissement</span><p>Lycée Jean Rostand</p></div><div class='timeline-description-block'><span class='timeline-subtitle'>Description</span><p>Formation axée sur les techniques de laboratoire (instruments de mesure, d'analyse et d'observation) et les procédés industriels.</p></div><div class='timeline-courses-block'><span class='timeline-subtitle'>Cours et TP</span><ul><li>Physique instrumentale</li><li>Thermodynamique</li><li>Chimie</li><li>Électricité</li><li>Mécanique</li></ul></div>",
        "type": "education",
...
export const CERTIFICATIONS_DATA = [
    ...
    },
    {
        ...
        "items": [
            { name: "Développer un état d'esprit d'apprenant", link: "https://www.linkedin.com/learning/certificates/668482280dbcb5fdc0ee3d35795e3b2f80d316cb28398784ff43f54b5ed2b345?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Developper un etat desprit dapprenant.pdf" },
            { name: "Rédiger un CV", link: "https://www.linkedin.com/learning/certificates/78b23301eb3d4bb37d08af8d4bcdca25a03b318d5bf86493a5daf173298360f0?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Rediger un CV.pdf" },
            ...
            { name: "Les fondements de la programmation : La conception orientée objet", link: "https://www.linkedin.com/learning/certificates/36ef92fbcc316147d6d47f04299f2c0a4415e7f0411d161c491f6293c2c36429?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Les fondements de la programmation  La conception orientee objet.pdf" },
            { name: "Machine learning : Les algorithmes d'apprentissage", link: "https://www.linkedin.com/learning/certificates/5d4a41b05aef7c457830e874ee2a9853838a5d211c2bd01dc396d146a40a2ceb?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Machine learning  Les algorithmes dapprentissage.pdf" },
            { name: "Programming Foundations: Algorithms", link: "https://www.linkedin.com/learning/certificates/6946d460f9e1392ce895304413a6cecc09acb9bbb9ade4258df7a4a3dc0f5b13?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Programming Foundations Algorithms.pdf" },
            { name: "Découvrir la modélisation UML", link: "https://www.linkedin.com/learning/certificates/f9c01d667027173f1ac0654eff912f86c9d6f74ff4b837c6429aa4b445982d9b?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Decouvrir la modelisation UML.pdf" },
            { name: "L'essentiel de SQL", link: "https://www.linkedin.com/learning/certificates/cb9e63230cb93c2c01200b852e98b032a31ba9285e7648d6ffb3b7b10914d0b6?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_Lessentiel de SQL.pdf" },
            { name: "SQL avancé pour les data scientists", link: "https://www.linkedin.com/learning/certificates/8a9b272c61cf6ba1c277209d780bd7289403db2f12ef5145ae3523a3dfe6b7d8?trk=share_certificate", file: "linkedin_learnings/CertificatDaccomplissement_SQL avance pour les data scientists.pdf" },
