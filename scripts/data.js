...
export const TIMELINE_DATA = [
    ...
    },
    {
        ...
        "description": "<strong>Formation via Docstrings, OpenClassrooms, Machine Learnia, Kaggle</strong><br><em>Certifications :</em> OpenClassrooms, Google Cloud/IA, SecNum Académie.<br><span style=\"font-size:0.9em; opacity:0.8\"><em>Légende : * Bases | ** Notions</em></span><br><br><h4>Développement Python :</h4><ul><li><i class=\"fab fa-python timeline-icon\"></i> Django*, Flask, FastAPI*</li><li>Bonnes pratiques PEP, scripts modulaires</li></ul><h4>Automatisation :</h4><ul><li>Requests, BeautifulSoup, Selenium**, PyAutoGUI**</li><li>Pipenv, Virtualenv, <i class=\"fab fa-docker timeline-icon\"></i> Docker</li></ul><h4>Data & Analyse :</h4><ul><li>Pandas, NumPy, visualisation (Matplotlib, Seaborn, Plotly)</li><li>SQLAlchemy, Psycopg2, PyMongo</li></ul><h4>Machine Learning* & Deep Learning** :</h4><ul><li>Modèles supervisés/non-supervisés, Feature engineering, Cross-validation</li><li>Scikit-learn, TensorFlow*/Keras**, PyTorch*</li></ul><h4>IA & LLMs :</h4><ul><li>Transformers, LangChain, LlamaIndex*, Whisper, OpenAI SDK</li><li>Modèles génératifs, CNN** / RAG*</li></ul><h4>MLOps & Data Engineering :</h4><ul><li>Notions Airflow, Luigi, déploiement/monitoring de modèles</li></ul><h4>Expérimentations :</h4><ul><li>Jupyter Notebooks, Scrapy, Streamlit*, Dask**, OpenCV**</li></ul>",
        "type": "education",
        "url": null,
