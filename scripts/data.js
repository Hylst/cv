...
export const TIMELINE_DATA = [
    {
        ...
        "description": "<div class='timeline-meta-block'><span class='date-highlight'>Création en cours - début d'activité visé : octobre 2026</span> <br> <span class='location-highlight'>Brumath (67) - Distanciel France entière & présentiel Alsace</span></div><div class='timeline-role-block'><span class='timeline-subtitle'>Activité</span><p>Entreprise individuelle de développement d'applications, de sites internet et de conseil en traitement des données &amp; intelligence artificielle. Double compétence technique et métier : je conçois des solutions qui répondent réellement à l'activité du client.</p></div><div class='timeline-courses-block'><span class='timeline-subtitle'>Offre de services</span>
<div class='services-accordion'>
  <details class='service-category'>
    <summary><i class='fas fa-code service-icon'></i> D&eacute;veloppement d'applications &amp; sites internet</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>Applications web sur mesure et applications m&eacute;tier</li>
        <li>Sites vitrines et sites e-commerce avec back-office (commandes, stocks, paiements)</li>
        <li>Reprise et s&eacute;curisation de sites et applications existants</li>
        <li>Migrations d'applications et de sites internet</li>
        <li>Optimisation du r&eacute;f&eacute;rencement, de l'exp&eacute;rience utilisateur et des co&ucirc;ts de fonctionnement</li>
      </ul>
      <p class='service-note'><i class='fas fa-universal-access'></i> Accessibilit&eacute; RGAA/WCAG int&eacute;gr&eacute;e d&egrave;s la conception.</p>
    </div>
  </details>
  <details class='service-category'>
    <summary><i class='fas fa-database service-icon'></i> Num&eacute;risation, donn&eacute;es &amp; gouvernance</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>Accompagnement &agrave; la num&eacute;risation et &agrave; la centralisation des documents</li>
        <li>Conseil en gouvernance : strat&eacute;gie de stockage, structure, acc&egrave;s et flux de donn&eacute;es</li>
        <li>Organisation et traitement des donn&eacute;es</li>
        <li>Solutions de recherche, assistance et automatisation par intelligence artificielle</li>
        <li>Structuration de donn&eacute;es, tableaux de bord, accompagnement RGPD et souverainet&eacute;</li>
      </ul>
      <p class='service-note'><i class='fas fa-shield-alt'></i> Souverainet&eacute; et confidentialit&eacute; : h&eacute;bergement europ&eacute;en, s&eacute;curit&eacute;, r&eacute;silience.</p>
    </div>
  </details>
  <details class='service-category'>
    <summary><i class='fas fa-robot service-icon'></i> Conseil &amp; int&eacute;gration d'IA</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>&Eacute;tude de faisabilit&eacute; et s&eacute;lection de solutions d'IA adapt&eacute;es &agrave; votre activit&eacute;</li>
        <li>Int&eacute;gration d'assistants et chatbots sur votre site ou outils internes</li>
        <li>Automatisation intelligente de t&acirc;ches r&eacute;p&eacute;titives (documents, e-mails)</li>
        <li>Formation de vos &eacute;quipes aux usages responsables de l'IA</li>
        <li>Cadrage et int&eacute;gration dans un cadre d'utilisation encadr&eacute; et s&eacute;curis&eacute;</li>
      </ul>
      <p class='service-note'><i class='fas fa-balance-scale'></i> Conformit&eacute; AI Act europ&eacute;en, transparence et approche sobre.</p>
    </div>
  </details>
  <details class='service-category'>
    <summary><i class='fas fa-tasks service-icon'></i> Gestion de projets num&eacute;riques</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>Cadrage et r&eacute;daction de cahier des charges</li>
        <li>Pilotage de projets de sites ou d'applications</li>
        <li>Coordination entre &eacute;quipes techniques et &eacute;quipes m&eacute;tier</li>
        <li>Suivi budg&eacute;taire, reporting et recette</li>
      </ul>
    </div>
  </details>
  <details class='service-category'>
    <summary><i class='fas fa-palette service-icon'></i> Design &amp; cr&eacute;ation de m&eacute;dias</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>Cr&eacute;ation d'identit&eacute; visuelle (logo, charte graphique, supports)</li>
        <li>Composition de musiques originales, jingles et habillage sonore</li>
        <li>Montage vid&eacute;o et motion design</li>
        <li>Traitement audio : nettoyage, mixage, sound design</li>
        <li>Visuels 3D et illustrations</li>
      </ul>
      <p class='service-note'><em>Cr&eacute;ations sign&eacute;es Hylst, alias artistique du fondateur.</em></p>
    </div>
  </details>
  <details class='service-category'>
    <summary><i class='fas fa-pen-fancy service-icon'></i> R&eacute;daction technique, commerciale &amp; litt&eacute;raire</summary>
    <div class='service-content'>
      <ul class='service-list'>
        <li>Documentation utilisateur et guides de prise en main</li>
        <li>Contenus de site vitrine, newsletters et e-mails commerciaux</li>
        <li>R&eacute;daction ou relecture de cahiers des charges en langage clair</li>
        <li>Structuration et relecture de manuscrits ou d'ouvrages techniques</li>
      </ul>
    </div>
  </details>
</div>
